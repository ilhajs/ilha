// =============================================================================
// @ilha/store/persist — persist() + persistQuery()
//
// Storage backends for store state:
// - persist(): localStorage / sessionStorage (re-exported from the main entry)
// - persistQuery(): URL search params (?q=abc&page=2), nuqs-style
//
// URL writes go through @ilha/router's navigate() (auto-detected, or injected
// via options) so loaders re-run and route signals stay correct.
//
...
export { persist, type PersistOptions, type PersistStorage } from "./index";
