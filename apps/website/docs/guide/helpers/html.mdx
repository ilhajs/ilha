...
- Do not use html for CSS or attribute values where HTML escaping is not appropriate — use CSS files, CSS Modules, or plain template literals for stylesheets.
