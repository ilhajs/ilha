...
| `@ilha/router/ssr`           | `setFrameGuard()`, `setLoaderGuard()`, `setFrameAuth()` — gate frame requests.       |
...
| SSR, server islands, and server pages | [Server islands](/guide/routing/server-islands)                   |
